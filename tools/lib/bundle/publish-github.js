    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (rs, rj) {
                    github(options, function (err, res) {
                        if (err) {
                            rj(err);
                        }
                        else {
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var packages, f0, date, y, m, d, h, min, s, commit, body, options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                packages = glob
                    ...
                    .sort()
                    .map(function (p) {
                    var packageJson = require(path.resolve(p));
